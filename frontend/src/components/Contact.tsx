...
const Contact = () => {
  return (
    <section id="contact" className="py-24 px-6 md:px-12 lg:px-24 bg-cream overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        
        {/* Left Side: Animated Contact Information */}
        <motion.div 
        ...
        {/* Right Side: Animated Contact Form Card */}
        <motion.div 
          initial={{ x: 50, opacity: 0 }}
          whileInView={{ x: 0, opacity: 1 }}
          viewport={{ once: true, margin: "-100px" }}
        ...
        >
          <form className="space-y-6 font-sans">
            ...
            <div>
              ...
              <select className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-primary focus:ring-2 focus:ring-green-100 outline-none transition-all bg-white cursor-pointer">
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full bg-primary hover:bg-green-800 text-white font-bold py-4 rounded-lg flex items-center justify-center gap-2 transition-colors cursor-pointer shadow-md"
            >
